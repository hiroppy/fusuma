...
When `npx fusuma start` is executed, fusuma will create a slide as follows then serve `http://localhost:8080`, and then you can write slides with HMR. In addition, Fusuma adds a sidebar like below. When you set section titles, fusuma shows them on the sidebar.
